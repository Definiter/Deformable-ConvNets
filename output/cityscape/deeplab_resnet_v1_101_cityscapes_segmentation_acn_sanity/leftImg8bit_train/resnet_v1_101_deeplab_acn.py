...
class resnet_v1_101_deeplab_acn(Symbol):
    ...
    def get_resnet_conv(self, data):
        ...
        # MODIFIED
        res5a_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5a_branch2b', data=res5a_branch2a_relu, num_filter=512,
        ...
        # MODIFIED
        res5b_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5b_branch2b', data=res5b_branch2a_relu, num_filter=512,
                                               pad=(2, 2), kernel=(3, 3), dilate=(2, 2), stride=(1, 1), no_bias=True)
        ...
        # MODIFIED
        res5c_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5c_branch2b', data=res5c_branch2a_relu, num_filter=512,
                                               pad=(2, 2), kernel=(3, 3), dilate=(2, 2), stride=(1, 1), no_bias=True)
