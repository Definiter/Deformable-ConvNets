...
class resnet_v1_101_deeplab_acn(Symbol):
    def __init__(self):
        """
    ...
    def get_resnet_conv(self, data):
        ...
        res5a_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5a_branch2b', data=res5a_branch2a_relu,
                                                                 num_filter=512, pad=(2, 2), kernel=(3, 3), num_active_group=1,
        ...
        res5b_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5b_branch2b', data=res5b_branch2a_relu,
                                                                 num_filter=512, pad=(2, 2), kernel=(3, 3), num_active_group=1,
                                                                 stride=(1, 1), dilate=(2, 2), no_bias=True)
        ...
        res5c_branch2b = mx.contrib.symbol.ActiveConvolution(name='res5c_branch2b', data=res5c_branch2a_relu,
                                                                 num_filter=512, pad=(2, 2), kernel=(3, 3), num_active_group=1,
                                                                 stride=(1, 1), dilate=(2, 2), no_bias=True)
    ...
    def init_weights(self, cfg, arg_params, aux_params):
        arg_params['res5a_branch2b_offset'] = mx.nd.zeros(shape=self.arg_shape_dict['res5a_branch2b_offset'])
        arg_params['res5b_branch2b_offset'] = mx.nd.zeros(shape=self.arg_shape_dict['res5b_branch2b_offset'])
        arg_params['res5c_branch2b_offset'] = mx.nd.zeros(shape=self.arg_shape_dict['res5c_branch2b_offset'])
