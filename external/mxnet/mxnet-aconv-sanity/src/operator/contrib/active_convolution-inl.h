#ifndef MXNET_OPERATOR_CONTRIB_ACTIVE_CONVOLUTION_INL_H_
#define MXNET_OPERATOR_CONTRIB_ACTIVE_CONVOLUTION_INL_H_
...
namespace conv {
  enum ActiveConvolutionOpInputs {kData, kWeight, kBias};
 ...
 public:
  ...
  virtual void Forward(const OpContext &ctx,
    ...
    for (index_t n = 0; n < num_; ++n) {
      ...
      active_im2col(s, in_data[conv::kData].dptr<DType>()+n*input_dim_, in_data[conv::kData].shape_,
  ...
  virtual void Backward(const OpContext &ctx,
    ...
    for (index_t n = 0; n < num_; ++n) {
      ...
      active_col2im(s, col_buffer.dptr<DType>(), in_grad[conv::kData].shape_, col_buffer.shape_,
