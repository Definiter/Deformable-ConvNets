...
.add_argument("data", "NDArray-or-Symbol", "Input data to the ActiveConvolutionOp.")
.add_argument("offset", "NDArray-or-Symbol", "Offset to the ActiveConvolutionOp.")
