...
print os.path.join(curr_path, '../external/mxnet', config.MXNET_VERSION, 'python')
sys.path.insert(0, os.path.join(curr_path, '../external/mxnet', config.MXNET_VERSION, 'python'))
